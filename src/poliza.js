    ...
    invokeURL(urlTarget,payload) {
        ...
        return new Promise((resolve, reject) => {
            Request(urlTarget, function (error, response, body) {
                ...
                UFsinhijos.texto = "El total de la empresa a pagar por empleador sin hijos son: "+ UFsinhijos.suma.toFixed(4) +" que cubre la empresa con una cantidad de " +UFsinhijos.contador+ " trabajadores y cada uno debera realizar un copago de: " + UFsinhijos.copago.toFixed(4) +", la cobertura dental por parte de la empresa es de:" + UFsinhijos.cobdental.pagoEmpresaDent.toFixed(4) +" y el copago del trabajador sera de: " + UFsinhijos.cobdental.copagoDent.toFixed(4) ;
                UFconhijos.texto = "El total de la empresa a pagar por empleador con hijos son: "+ UFconhijos.suma.toFixed(4)+" que cubre la empresa con una cantidad de " +UFconhijos.contador+ " trabajadores y cada uno deberan realizar un copago de: " + UFconhijos.copago.toFixed(4) +", la cobertura dental por parte de la empresa es de:" + UFconhijos.cobdental.pagoEmpresaDent.toFixed(4) +" y el copago del trabajador sera de: " + UFconhijos.cobdental.copagoDent.toFixed(4);
                UF2omashijos.texto = "El total de la empresa a pagar por empleador con 2 hijos o mas son: "+ UF2omashijos.suma.toFixed(4)+" que cubre la empresa con una cantidad de " +UF2omashijos.contador+ " trabajadores y cada uno deberan realizar un copago de: " + UF2omashijos.copago.toFixed(4) +", la cobertura dental por parte de la empresa es de:" + UF2omashijos.cobdental.pagoEmpresaDent.toFixed(4) +" y el copago del trabajador sera de: " + UF2omashijos.cobdental.copagoDent.toFixed(4);
